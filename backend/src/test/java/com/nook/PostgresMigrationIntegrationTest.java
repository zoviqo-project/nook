...
class PostgresMigrationIntegrationTest {
  ...
  @Test void flywayCreatesCurrentProductionSchemaAndUniqueConstraints(){
    ...
    assertThat(jdbc.queryForObject("select count(*) from information_schema.tables where table_schema='public' and table_name in ('users','matches','coffee_date_proposals','messages','user_settings')",Integer.class)).isEqualTo(5);
