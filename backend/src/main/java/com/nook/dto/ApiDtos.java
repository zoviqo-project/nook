...
public final class ApiDtos { private ApiDtos(){}
 ...
 public record UpdateMe(@Size(min=1,max=80) String name,LocalDate birthDate,Gender gender,@Size(max=500) String bio,@Size(max=100) String city,Double latitude,Double longitude,LookingFor lookingFor,@Size(max=80) String coffeePersonality,@Size(max=60) String preferredPlan,@Size(max=80) String preferredVibe,@Min(0) @Max(4) Integer coffeesPerDay,@Size(max=80) String favoriteCoffeeMoment,@Min(18) Integer minAge,@Max(100) Integer maxAge,@Min(1) @Max(200) Integer maxDistanceKm,Boolean visible,Boolean hidden,@Size(max=20) List<@Size(max=30) String> coffeePreferences,Boolean onboardingComplete,@Size(max=20) List<@Size(max=40) String> desiredGenders,@Size(max=20) List<@Size(max=40) String> discoveryIntentions,@Size(max=20) List<@Size(max=40) String> discoveryVibes,@Size(max=20) List<@Size(max=40) String> discoveryMoments,@Size(max=20) List<@Size(max=40) String> discoveryMeetingStyles){}
